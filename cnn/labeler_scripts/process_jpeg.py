...
if __name__ == '__main__':
    labeler = darknetLabeler()
    # labels = labeler.labelDarknet('/home/egm42/sign-spotter/cnn/jpegs/REC_2020_04_04_08_40_13_F_57_image_r.jpg')
    print('_______1_____________')
    labels = labeler.labelDarknet('/home/egm42/sign-spotter/cnn/models/darknet/1alt.jpg', 'right')
    print('_______2_____________')
    labels = labeler.labelDarknet('/home/egm42/sign-spotter/cnn/models/darknet/2alt.jpg', 'right')
    print('_______3_____________')
    labels = labeler.labelDarknet('/home/egm42/sign-spotter/cnn/models/darknet/3alt.jpg', 'right')
    print('_______4_____________')
    labels = labeler.labelDarknet('/home/egm42/sign-spotter/cnn/models/darknet/4alt.jpg', 'right')
    # print(labels)
